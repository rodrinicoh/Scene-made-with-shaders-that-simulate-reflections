Shader "Unlit/CookYTorranceLucesYManchas"
{
    Properties
    {
       ...
       [NoScaleOffset] _MainTex3 ("Texture3", 2D) = "white" {} 
        ...
        u_resolutionx ("Resolutionx", Range (0.0,1.0)) = 1
        u_resolutiony ("Resolutiony", Range (0.0,1.0)) = 1
