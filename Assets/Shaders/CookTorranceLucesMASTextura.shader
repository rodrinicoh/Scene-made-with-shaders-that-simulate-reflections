Shader "Unlit/CookTorranceLucesMASTextura"
{
    Properties
    {
       ...
       [NoScaleOffset] _MainTex ("Texture", 2D) = "white" {} //en _MainTex se guarda la textura
        ...
        //difuso
        _MaterialKd("MaterialKd", Vector) = (0.925,0.04136,0.04136,1)
        _LightIntensity_d("LightIntensity_d", Color) = (1,1,1,1) //Ip
        _MaterialKs("MaterialKs", Vector) = (0.987,0.62695,0.62695,1)

        _AmbientLight("AmbientLight",Color) = (1,1,1,1)
        _MaterialKa("MaterialKa",Vector) = (0.7,0.134,0.176,0)
    ...
    SubShader
    {
        ...
        Pass{
            ...
            fixed4 fragmentShader (v2f i) : SV_Target{
                ...
                fragColor=(fragColor*_MaterialColor)+col;
                //fragColor+=col;
                return fragColor;
            }
            ENDCG
